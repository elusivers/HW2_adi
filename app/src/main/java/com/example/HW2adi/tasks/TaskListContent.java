package com.example.HW2adi.tasks;
...
public class TaskListContent {
    ...
    static {
        addItem ( new Task ( String.valueOf ( 1 ), "Mecz", "Mecz stadionowy", "10.10.2001" ) );
        addItem ( new Task ( String.valueOf ( 2 ), "Zlot", "Zlot motocyklowy", "08.08.97" ) );
    }
